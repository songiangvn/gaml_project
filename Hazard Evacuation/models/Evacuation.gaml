...
//			location <- {0, 0};
//		}
		create hazard from: water_body; //lấy cái khung của file shp(hay nó cách khác là geometry shape) những các đặc điểm khác
		// mình vẫn có thể tự định nghĩa lại được
...
experiment my_experiment type: gui{
	output {
		// lưu ý thứ tự vẽ của các species cũng quan trọng nếu vẽ inhabitant trước building thì inhabitant sẽ bị ẩn dưới building
